...
**Cite as:** BigScience Workshop ([link](https://bigscience.huggingface.co)), BigScience Language Open-source Open-access Multilingual (BLOOM). International, May 2021-May 2022.
...
The training supercomputer, Jean Zay ([article link](http://www.idris.fr/eng/jean-zay/jean-zay-presentation-eng.html)), uses mostly nuclear energy. The heat generated by it is reused for heating campus housing.
